schtasks /create /tn "MU Robot\Meditation" /tr "node D:\dev\murobot\lib\meditation.js" /sc DAILY /st 03:29
...
schtasks /create /tn "MU Robot\Queue" /tr D:\dev\murobot\schedule\queue.bat /sc DAILY /st 06:00
pause